...
func TestWorkerFixturesValidate(t *testing.T) {
	command := Command{SchemaVersion: CommandSchemaVersion, MessageID: "msg_probe_001", Capability: "probe", ProjectID: "project_probe_001", JobID: "job_probe_001", PipelineRunID: "run_probe_001", JobStepID: "step_probe_001", PipelineNodeID: "node_probe_001", Attempt: 1, InputRefs: []ArtifactRef{{ArtifactID: "artifact_source_001", Role: "source", SHA256: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}}, Config: map[string]any{"thumbnail": false}}
...
func TestWorkerContractsRejectPathsAndUnknownStatus(t *testing.T) {
	command := Command{SchemaVersion: CommandSchemaVersion, MessageID: "msg_probe_001", Capability: "probe", ProjectID: "project_probe_001", JobID: "job_probe_001", PipelineRunID: "run_probe_001", JobStepID: "step_probe_001", Attempt: 1, InputRefs: []ArtifactRef{}, Config: map[string]any{"local_path": "C:/secret"}}
	if err := ValidateCommand(command); err == nil {
