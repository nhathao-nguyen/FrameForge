...
PLAN_MARKERS = {
    "SETUP-PLAN.md": ("apps/desktop", "V0", "V10", "clean-room", "OQ-15"),
    "PRODUCTION-PLAN.md": ("Phase -1", "Phase 7", "T433", "T605", "canary", "rollback"),
    "PRODUCTION-EXECUTION-PROMPT.md": ("AGENTS.md", "Implement đúng một task/PR-sized change", "handoff", "production-ready"),
}
...
def check_branch_commit(errors: list[str]) -> None:
    ...
    if branch != "develop":
        errors.append(f"expected current branch develop, got {branch!r}")
